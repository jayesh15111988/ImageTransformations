...
int main(int argc, char *argv[])
{
  ...
  SImageIO::write_png_file("mean.png", mean_filtered, mean_filtered, mean_filtered);
 ...
 SDoublePlane overlay_plane = hough_circles(edges, hough_radius, hough_vote);
  SImageIO::write_png_file("detected.png",overlay_plane,overlay_plane,overlay_plane);
}
