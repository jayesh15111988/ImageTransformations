...
int main(int argc, char *argv[])
{
 ...
 SDoublePlane overlay_plane = hough_circles(edges, hough_radius, hough_vote);
  SImageIO::write_png_file("new_detected.png",overlay_plane,overlay_plane,overlay_plane);
}
